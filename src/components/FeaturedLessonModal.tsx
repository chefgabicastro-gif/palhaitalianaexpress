...
import { X, Play, Clock, Sparkles, FileDown, BookOpen, ChefHat, Eye } from "lucide-react";
...
export const FeaturedLessonModal = forwardRef<HTMLDivElement, FeaturedLessonModalProps>(({ 
  lesson, 
  isOpen, 
  onClose
}, ref) => {
...
FeaturedLessonModal.displayName = 'FeaturedLessonModal';
