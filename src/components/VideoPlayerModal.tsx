...
import { X, Play, CheckCircle, Star, Clock, Sparkles, Crown, FileDown, BookOpen, Eye } from "lucide-react";
...
export const VideoPlayerModal = forwardRef<HTMLDivElement, VideoPlayerModalProps>(({ 
  lesson, 
  isOpen, 
  onClose, 
  isCompleted,
  ...
  // Construir URL absoluta para o PDF
  const getPdfUrl = () => {
    if (!lesson.materialUrl) return '';
    const baseUrl = window.location.origin;
    return `${baseUrl}${lesson.materialUrl}`;
  };
  ...
  const handleDownloadPdf = () => {
    ...
    if (url) {
      ...
      link.href = url;
      link.download = (lesson.materialName || 'Material da Aula') + '.pdf';
      link.target = '_blank';
          ...
          <AnimatePresence mode="wait">
            ...
            >
                ...
                {!isPlaying ? (
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-primary/90 flex items-center justify-center shadow-2xl shadow-primary/50 cursor-pointer hover:scale-110 active:scale-95 transition-transform">
              ...
              <div className="p-4 md:p-6 space-y-4">
                ...
                {lesson.materialUrl && (
                  <div className="p-4 rounded-xl bg-gradient-to-br from-accent/10 via-primary/5 to-gold/10 border border-primary/20">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">Visualize ou baixe o material de apoio</p>
                      </div>
                    </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  {isCompleted ? (
                    ...
                    <button
                      className="flex-1 py-3 px-6 rounded-xl bg-gradient-to-r from-primary to-accent text-primary-foreground font-bold flex items-center justify-center gap-2 shadow-lg shadow-primary/30 hover:scale-[1.02] active:scale-[0.98] transition-transform"
